...
%%Polybar-scripts -----------------------------------------------
%	\cventry
%      {Contributor (\href{https://github.com/x70b1/polybar-scripts}{GitHub Link})}
...
%%Course Planner----------------------------------------------------------
%  \cventry
%    {Personal Project (\href{https://github.com/DJSiddharthVader/coursePlanning2017}{GitHub Link})}
